...
### 4.8. Xác nhận sự kiện cuối — `POST /api/book-event/{id}/confirm`
...
## 6. Test end-to-end (gợi ý thứ tự)
...
## 7. Số tiền hợp đồng / cọc quá lớn — có sửa DB được không?
...
*Tài liệu sinh ra để test thủ công; nếu đổi route hoặc role trong code, cập nhật lại bảng tương ứng.*
